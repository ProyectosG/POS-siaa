...
export default function OverlayKardexProductosPorNombre({
  resultados = [],
  selectedIndex = 0,
  setSelectedIndex,
  onSelect,
              ...
              {resultados.map((p, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2">{prod.articulo}</td>
                    <td className="px-3 py-2">{prod.presentacion}</td>
