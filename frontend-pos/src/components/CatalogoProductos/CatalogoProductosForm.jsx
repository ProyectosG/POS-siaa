...
import TabGeneral from "./1tabs/TabGeneral";
import TabPrecios from "./1tabs/TabPrecios";
import TabInventario from "./1tabs/TabInventario";
import TabImagen from "./1tabs/TabImagen";
